...
const Showcase = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-[#020202] overflow-hidden transition-opacity duration-700"
    >
      <div className="relative w-full h-[60vh] md:h-[80vh] lg:h-screen max-h-[1080px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4 pointer-events-none">
          <h1 className="flex flex-col items-center text-center">
            ...
            <span className="overflow-hidden block">
              <span className="showcase-line block text-4xl sm:text-6xl md:text-8xl font-bold text-white tracking-tighter leading-none">
                {data.content.headline.line_2.prefix}{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#FF0F43] to-[#B3002D] drop-shadow-[0_0_20px_rgba(227,27,99,0.4)]">
                  {data.content.headline.line_2.highlight}
                </span>
                {data.content.headline.line_2.suffix}
              </span>
            </span>
