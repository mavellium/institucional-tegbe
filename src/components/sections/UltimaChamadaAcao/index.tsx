      ...
      <div className="relative z-10 max-w-4xl w-full text-center space-y-10">
        <h2 className="text-5xl md:text-7xl font-bold text-[#050505] tracking-tighter leading-[1.05]">
          ...
          <span
            ...
            style={{
              backgroundImage: `linear-gradient(to right, ${theme.gold_start}, ${theme.gold_end})`,
            }}
          >
            {text.highlight}
          </span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-6">
          <Link href={calls_to_action.primary.href} className="group relative">
            ...
            <div
              ...
              style={{
                background: `linear-gradient(to right, ${theme.gold_start}, ${theme.gold_end})`,
              }}
            />

            <button className="relative overflow-hidden px-10 py-5 rounded-full font-black text-sm uppercase tracking-[0.2em] transition-all duration-500 flex items-center gap-4 shadow-xl bg-[#0A0A0A]">
              {/* LAYER DE PREENCHIMENTO BRANCO: sobe no hover */}
              <div className="absolute inset-0 translate-y-[101%] group-hover:translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.19,1,0.22,1)] bg-white" />
