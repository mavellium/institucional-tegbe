        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-auto lg:min-h-[600px]">
          ...
          >
            ...
            <div className="relative z-10">
              <div
                className="w-16 h-16 rounded-2xl flex items-center justify-center mb-10 shadow-lg shadow-rose-900/40"
              ...
              <div className="flex flex-wrap gap-2">
                {cards.main_tower.tags?.map((tag, i) => (
                  <span
                    key={i}
                    className="px-3 py-1 rounded-lg border border-white/10 text-[10px] font-bold text-zinc-500 bg-white/5 uppercase tracking-tighter"
                  >
                    {tag}
                  </span>
                ))}
            ...
            >
              <div className="absolute inset-0 translate-y-[101%] group-hover/btn:translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.19,1,0.22,1)] bg-white" />
            ...
            >
              ...
              <div className="relative">
                <div className="w-28 h-28 rounded-3xl bg-white/5 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 border border-white/10">
                  <Icon
                    icon={cards.creative_stack.icon}
                    className="w-12 h-12"
                    style={{ color: theme.accent_pink }}
                  />
                </div>
                <div
                  className="absolute -bottom-2 -right-2 text-white px-4 py-1.5 rounded-lg shadow-lg text-[10px] font-black uppercase tracking-widest"
