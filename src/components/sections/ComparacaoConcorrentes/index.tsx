...
export default function ComparacaoConcorrentes({ endpoint = "comparacao", data: dataProp }: Props) {
  const { data: fetched, loading } = useApi<ComparisonData>(dataProp ? "" : endpoint);
