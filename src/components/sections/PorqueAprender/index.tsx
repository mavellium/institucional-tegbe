...
/* =========================
   COMPONENT
========================= */
export default function PorqueAprender({ data }: { data: PorqueAprenderData | null }) {
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center flex flex-col items-center">
        ...
        <Heading
          color="white"
          align="center"
          className="reveal-text-p font-bold text-3xl md:text-6xl leading-tight tracking-tight text-white max-w-4xl mb-6"
        >
