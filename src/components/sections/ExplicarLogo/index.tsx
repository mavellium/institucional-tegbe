...
const valores = [
  {
    ...
    cor: "#B38E5D",
    texto:
      "Vivemos o Beta Contínuo. Acreditamos que negócios e pessoas podem evoluir sempre. Ajustamos rotas, refinamos processos e ampliamos visão até que haja clareza, eficiência e confiança. Transformar é crescer de dentro para fora, fortalecendo a operação e quem está por trás dela.",
  },
  {
    titulo: "Excelência",
    icon: "ph:crown-bold",
    cor: "#D4AF37",
    texto:
      "Excelência é escolher ser melhor todos os dias. É não se contentar com o suficiente quando sabemos que é possível fazer extraordinário. Levamos o nosso melhor para desenvolver o melhor do seu negócio e das suas pessoas. Refinamos, aprimoramos e elevamos padrões continuamente.",
  },
  {
    titulo: "Growth",
    ...
    cor: "#C5A47E",
    texto:
      "Crescimento é a consequência natural da evolução constante. Quando o negócio ganha estrutura e as pessoas ganham clareza e competência, a escala deixa de ser um risco e passa a ser um movimento calculado. Construímos expansão sustentável e legado duradouro.",
  },
];
    ...
    <section ref={containerRef} className="relative bg-[#FAF9F6] py-24 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <header className="text-center mb-24 space-y-4">
          <span className="text-[10px] font-bold tracking-[0.4em] text-[#B38E5D] uppercase">
            O DNA da Tegbe
          </span>
          ...
          {valores.map((item, i) => (
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-[#1A2B3C]/70 text-sm leading-relaxed font-light">{item.texto}</p>
              </div>
            </div>
          ))}
        </div>
