...
const courses = [
  {
    ...
    description: "Aprenda a estruturar, operar e gerir lojas online de forma profissional e altamente escalável.",
    tag: "Presencial",
  ...
  },
  {
    ...
    description: "Domine as estratégias de tráfego pago, funis de conversão e aquisição orgânica de clientes.",
    tag: "Masterclass",
  ...
  },
  {
    ...
    description: "Técnicas validadas para posicionar produtos e se destacar no Mercado Livre, Amazon e Shopee.",
    tag: "Presencial",
  ...
  },
  {
    ...
    description: "Crie imagens que convertem. Da iluminação básica à edição profissional voltada para conversão.",
    tag: "Workshop",
...
export default function FormacoesSection() {
  ...
  return (
    <section id="formacoes" className="relative py-32 bg-neutral-950 text-white overflow-hidden selection:bg-white selection:text-neutral-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-lg md:text-xl text-neutral-400 font-normal max-w-2xl leading-relaxed">
            Cursos práticos e intensivos desenhados para você dominar o mercado digital. Networking de alto nível garantido.
          </p>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="relative bg-white/[0.02] backdrop-blur-md rounded-[2rem] border border-white/10 shadow-[0_8px_40px_rgba(0,0,0,0.5)] overflow-hidden transition-all duration-500">
            ...
            <div className={`absolute inset-0 bg-gradient-to-br ${courses[current].accent} to-transparent transition-colors duration-700 pointer-events-none opacity-60`} />
            ...
            {/* CONSOLE DE NAVEGAÇÃO INTEGRADO */}
