    ...
    <section className="py-32 px-6 bg-white relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0">
           ...
           {/* CONECTOR DESKTOP (LINHA DE FLUXO) */}
...
function StepCard({ data, index, totalSteps }: { data: Step, index: number, totalSteps: number }) {
    return (
        ...
        >
            {/* CONECTOR MOBILE - Layout horizontal elegante */}
            <div className="md:hidden">
                {/* Container com layout horizontal */}
                <div className="flex items-start gap-6 px-4">
                    
                    {/* Coluna da linha vertical e ícone */}
                    <div className="flex flex-col items-center relative">
                        {/* Linha vertical superior (para todos exceto o primeiro) - FIXA */}
                        {index > 0 && (
                        ...
                        {/* Linha vertical inferior (para todos exceto o último) - FIXA */}
                        {index < totalSteps - 1 && (
                        ...
                        {/* Ponto decorativo na linha - FIXO */}
                        {index < totalSteps - 1 && (
                    ...
                    <div className="flex-1 pt-2">
                        ...
                        {/* Linha horizontal decorativa - FIXA */}
