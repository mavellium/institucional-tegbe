...
const services = [
  {
    ...
    description: "Decisões baseadas em GA4 e rastreamento avançado (nada de 'achismo').",
  ...
  },
  {
    step: "02",
    id: "ads",
    title: "Criação Convertora",
    description: "Design e copy que obrigam o clique.",
  ...
  },
  {
    step: "03",
    id: "blindagem",
    title: "Otimização Obsessiva",
    description: "Melhoria contínua de ROI.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 text-center section-title will-change-transform">
          <h2 className="text-4xl md:text-5xl font-black text-black tracking-tight mb-4">
            Porque temos tantos resultados?
          </h2>
