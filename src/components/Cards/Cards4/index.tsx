...
const services = [
  {
    step: "01",
    id: "seo",
    title: "Decisão via Dados",
    description: "O 'achismo' é proibido. Monitoramos cada clique e conversão via GA4 e GTM para saber exatamente para onde vai cada centavo investido.",
  ...
  },
  {
    ...
    description: "Dominamos a dinâmica de Marketplaces e Lojas Virtuais. Sabemos como fazer o estoque girar e transformar tráfego em pedidos despachados.",
  ...
  },
  {
    ...
    description: "Sem caixas pretas. Você terá acesso claro aos números reais da sua operação. Jogamos juntos, com as cartas na mesa",
