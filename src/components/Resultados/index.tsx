...
export default function NewsCarousel() {
  ...
  return (
    // Padding lateral de 6 (px-6) e Max-Width de 7xl para padrão de borda Mavellium
    <section className="py-32 bg-[#020202] relative overflow-hidden font-sans">
            ...
            >
              {data.cases.map((item) => (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div className="h-full bg-[#0A0A0A] border border-white/5 rounded-[2.5rem] p-10 flex flex-col justify-between relative overflow-hidden transition-all duration-500 group-hover:border-yellow-400/40 group-hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)]">
                    
                    {/* Interior Glow Hover */}
                    <div className="absolute inset-0 bg-gradient-to-br from-yellow-400/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-10">
                          ...
                          <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-zinc-600 group-hover:bg-yellow-400 group-hover:text-black transition-all duration-500">
                    ...
                    <div className="flex flex-wrap gap-2.5 mt-auto relative z-10">
                      {item.tags.map((tag, i) => (
                           <span key={i} className="text-[10px] font-black px-4 py-2 rounded-xl bg-white/[0.03] text-zinc-400 border border-white/5 uppercase tracking-widest group-hover:border-yellow-400/20 group-hover:text-zinc-300 transition-all">
                              {tag}
                           </span>
                      ))}
                    </div>
                    ...
                    <div className="absolute -bottom-6 -right-6 text-yellow-400 opacity-0 group-hover:opacity-[0.03] transition-opacity duration-700 pointer-events-none scale-150 rotate-[-10deg]">
